...
export default function App(){
  ...
  if(purpose==="attendance-kiosk"){if(registration===undefined)return <View style={s.loading}><ActivityIndicator color="#55c894"/></View>;if(!registration)return <ActivationScreen onActivated={(next:Registration)=>{setRegistration(next);setAttendanceView("kiosk")}}/>;return <><StatusBar hidden/><KioskExperienceScreen registration={registration} onReset={()=>{setRegistration(null);setAttendanceView("register")}} onOpenSettings={changePurpose}/></>}
