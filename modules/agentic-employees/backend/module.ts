...
import { agenticWorkersAiRoutes } from "./workers-ai-routes";
import { agenticChatImageRoutes } from "./chat-image-routes";
...
export const moduleDefinition:BackendModuleDefinition={key:"agentic-employees",name:"AI Employees",version:"2.0.0",order:75,routes:[
 {basePath:"/api/v1/agentic-employees",router:agenticProviderRoutes},
 {basePath:"/api/v1/agentic-employees",router:agenticWorkersAiRoutes},
 // Multimodal routes intentionally come before the legacy text-only conversation handlers.
 {basePath:"/api/v1/agentic-employees",router:agenticChatImageRoutes},
 ...
 {basePath:"/api/v1/agentic-employees",router:agenticChatConfirmationRoutes},
 ...
 {basePath:"/api/v1/agentic-employees",router:agenticVisionRoutes},
 {basePath:"/api/v1/agentic-employees",router:agenticMemoryRoutes}],scheduled:async env=>{await detectDerivedEmployeeEvents(env);await processEventInbox(env);await runDueProactiveSchedules(env);}};
