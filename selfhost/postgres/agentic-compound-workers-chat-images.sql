...
ALTER TABLE ae_image_attachments ADD COLUMN IF NOT EXISTS conversation_id TEXT;
ALTER TABLE ae_image_attachments ADD COLUMN IF NOT EXISTS message_id TEXT;
ALTER TABLE ae_image_attachments ADD COLUMN IF NOT EXISTS purpose TEXT NOT NULL DEFAULT 'vision';
